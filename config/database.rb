...
database_name = case Padrino.env
  when :development then 'taosimnet_development'
  when :production  then 'taosimnet_production'
  when :test        then 'taosimnet_test'
end
...
#       default:
#         database: taosimnet_development
#         hosts:
#           - localhost:27017
#
#   production:
